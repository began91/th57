...
function AboutView() {
    return (
        <div className="instructions">
            ...
            <p>Remember: "Garbage in, garbage out." Your form will only be as accurate as the information you enter into the appropriate fields. Some entries have no effect on the final result and are for information purposes only. Other entries are used in the calculation of total weight and center of gravity.</p>
            <h3>Event</h3>
            <p>The event field is for information purposes only.</p>
            <h3>Instructor</h3>
            <p>Start typing your instructor's last name to bring up a dropdown of options matching the typed characters. Pick the appropriate instructor (be careful with common last names). The instructor's weight with wet vest will autopopulate into the form. You may select the dry vest weight or manually change the weight as necessary. The instructor weight value will be used to calculate Crew Forward weight.</p>
            ...
            <h3>Date</h3>
            <p>The date will autopopulate to today's date. It is for information purposes only.</p>
            <h3>Student</h3>
            ...
            <h3>Fuel</h3>
            <p>Select presets of 70 or 65 gallons, or a manually enter fuel in gallons. The "Set Max" button will set the maximum amount of fuel, up to 91 gallons, to keep the aircraft below 3200 lbs given the current Takeoff Gross Weight.</p>
            <h3>Crew Aft</h3>
