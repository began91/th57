...
const aircraftList = [
    ...
    acft('082','C', 2166.83, 2553.16),
    acft('083','C', 2145.37, 2493.77),
    acft('084','C', 2144.33, 2527.71),
    acft('085','C', 2157.2, 2502.05),
    acft('086','C', 2161.2, 2512.93),
    acft('087','C', 2148.5, 2534.01),
    acft('088','C', 2158.2, 2509.46),
    acft('089','C', 2151.85, 2537.64),
    acft('090','C', 2125.1, 2461.63),
    acft('092','C', 2114.6, 2453.79),
    acft('093','C', 2144.76, 2534.08),
    acft('094','C', 2111.3, 2447.2),
    acft('095','C', 2136.87, 2478.29),
    acft('096','C', 2162.98, 2514.94),
    acft('097','C', 2148.2, 2491.47),
    acft('098','C', 2152.4, 2535.25),
    acft('099','C', 2134.2, 2471.76),
    acft('100','C', 2148.03, 2485.98),
    acft('101','C', 2117.7, 2499.09),
    acft('102','C', 2135.2, 2468.72),
    acft('103','C', 2153.43, 2484.01),
    acft('104','C', 2167.3, 2554.56),
    acft('106','C', 2166.03, 2521.89),
    acft('107','C', 2170.8, 2561.02),
    acft('108','C', 2160.33, 2549.21),
    ...
    acft('156','B', 1980.7, 2346.68),
    acft('157','B', 1971.38, 2335.79),
    acft('158','B', 1990.7, 2357.18),
    acft('159','B', 1982.53, 2328.95),
    acft('160','B', 1989.88, 2359.09),
